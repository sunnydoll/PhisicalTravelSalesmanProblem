...
public class ExecSync extends Exec
{
    ...
    public static void main(String[] args)
    {
        ...
        //m_controllerName = "controllers.SteeringBehaviors.ZhichaoCaoController";
        m_controllerName = "controllers.SteeringBehaviors.ZhichaoCaoNoAvoidController";
        ...
        /////// 2. Executes one game.
        int delay = 2;  //0: quickest; PTSPConstants.DELAY: human play speed, PTSPConstants.ACTION_TIME_MS: max. controller delay
